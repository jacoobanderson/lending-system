...
public class Data implements Persistance {
  ...
  public void load(MemberRegister memberRegister) {
    ...
    personOne.createItem("Tool", "Hammer", "You can hammer stuff", 1, 50);
    personOne.createItem("Vehicle", "Car", "You can dive", 1, 10);
    personOne.addCredits(300);

    Item lendedItem = new Item("Tool", "Screwdriver", "You can screw", 1, 50, true);
    ...
    personOne.transferCredits(personThree, contract.getTotalCost());

    Member personTwo = new Member("Karl", "Karlsson", "karl@gmail.com", "0574123329", 1, "2d4F51");
    personTwo.addCredits(100);
